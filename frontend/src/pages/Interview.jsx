  ...
  return (
    ...
    <div className="min-h-screen flex flex-col bg-[#f4fbf7]">
      ...
      <div className="max-w-5xl mx-auto text-center mb-16">
        ...
        {/* Top Badge */}
        <div className="inline-flex items-center gap-2 bg-[#1FAA59]/10 text-[#1FAA59] text-xs font-semibold px-4 py-2 rounded-full mb-6">
          ● PLACEMENTS 2026
        </div>
        ...
        <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight">
          Prepare for Your{" "}
          <span className="text-[#1FAA59]">Interview</span>
        </h1>

        {/* Subheading */}
        <p className="text-gray-600 mt-6 text-lg max-w-2xl mx-auto leading-relaxed">
          Practice DSA, Reasoning and Quantitative Aptitude to ace your 
          placements with our industry-vetted curriculum.
        </p>
      </div>

      {/* Cards Section */}
      <div className="max-w-6xl mx-auto bg-white/70 backdrop-blur-md rounded-[40px] p-10 shadow-xl">
...
>
            <div className="flex justify-between items-start mb-6">
              <div className="w-14 h-14 bg-gradient-to-br from-[#1FAA59] to-[#178f4a] rounded-xl flex items-center justify-center shadow-md">
                <span className="text-white text-xl font-bold">{`</>`}</span>
              </div>

              <span className="text-xs bg-[#1FAA59]/10 text-[#1FAA59] px-3 py-1 rounded-full font-semibold">
                150+ QUESTIONS
              </span>
            </div>

            <h3 className="text-xl font-bold text-gray-800 mb-3">DSA</h3>

            <p className="text-gray-500 text-sm leading-relaxed mb-8">
              Master Data Structures and Algorithms with curated problems 
              ranging from arrays to advanced graphs.
            </p>

            <div className="bg-gradient-to-r from-[#1FAA59] to-[#178f4a] text-white text-sm font-semibold py-3 rounded-full flex items-center justify-center gap-2 shadow-md">
              Start Practice →
            </div>
          </Link>
...
>
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-3">Reasoning</h3>

            <p className="text-gray-500 text-sm leading-relaxed mb-8">
              Enhance your logical thinking and analytical skills with puzzles, 
              sequences, and critical reasoning.
            </p>
...
>
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-8">
              Practice math and aptitude problems for competitive exams 
              covering arithmetic to probability.
            </p>
