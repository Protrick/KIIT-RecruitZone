    ...
    <style>{`
      ...
      *, *::before, *::after {
      ...
      @keyframes cardOut {
        to {
          opacity: 0;
          transform: translateX(38px) scale(.93);
          max-height: 0;
          padding: 0;
          margin: 0;
          overflow: hidden;
      ...
      @keyframes inkBlot {
        0%   { opacity: 0; transform: scale(.8) translateY(-10px); filter: blur(6px); }
      ...
      @keyframes drift {
        ...
        36%       { transform: translateY(-9px) rotate(-3deg); }
      ...
      @keyframes stampIn {
        0%   { transform: scale(1.8) rotate(-14deg); opacity: 0; filter: blur(4px); }
      ...
      @keyframes btnPulse {
        0%, 100% { box-shadow: 0 4px 14px rgba(31, 170, 89, .28); }
        50%       { box-shadow: 0 4px 28px rgba(31, 170, 89, .54); }
      }
      ...
      @keyframes ripple {
        from { transform: translate(-50%, -50%) scale(0); opacity: .4; }
        to   { transform: translate(-50%, -50%) scale(2.8); opacity: 0; }
      }

      @keyframes focusRing {
        0%   { box-shadow: 0 0 0 0 rgba(31, 170, 89, .4); }
        100% { box-shadow: 0 0 0 7px rgba(31, 170, 89, 0); }
      }
      ...
      /* Scan-line shimmer that drifts down the header */
      .hdr::before {
        content: '';
        position: absolute;
        left: 0;
      ...
      .hdr-brand:hover .hdr-seal {
        transform: rotateY(28deg) rotateX(-8deg) scale(1.08);
        background: rgba(255, 255, 255, .3);
      }

      .hdr-brand:hover .hdr-seal::after {
      ...
      /* Underline that draws in on brand hover */
      .hdr-title::after {
        content: '';
        position: absolute;
        bottom: -2px;
      ...
      .hdr-brand:hover .hdr-title::after {
        width: 100%;
      }
      ...
      .sec-card:hover {
        box-shadow: 0 2px 6px rgba(0,0,0,.07), 0 10px 28px rgba(0,0,0,.09);
      }
      ...
      .sec-head:hover .sec-icon {
        ...
        box-shadow: 0 4px 16px rgba(31, 170, 89, .48);
      }
      ...
      .submit-card:hover {
        ...
        animation: none;
        box-shadow: 0 8px 28px rgba(31, 170, 89, .44);
      }
      ...
      /* Staggered fade-up for each field */
      .fg {
        opacity: 0;
        animation: fieldIn .5s cubic-bezier(.16, 1, .3, 1) forwards;
      }
      ...
      .sw::after {
        ...
        border-top: 5px solid #7a8a8a;
        pointer-events: none;
        transition: transform .28s ease;
      }

      .sw:focus-within::after {
      ...
      /* Inline number + period select (CTC / stipend) */
      .irow {
        display: flex;
        border: 1.5px solid #cdd8cd;
        border-radius: 8px;
      ...
      .upzone:hover {
        ...
        box-shadow: 0 8px 22px rgba(31, 170, 89, .14);
      }

      .upzone:hover .upico {
        animation: uploadBounce .55s ease infinite;
      }
      ...
      .prog-fill {
        height: 100%;
        border-radius: 3px;
        background: linear-gradient(90deg, #1FAA59, #34c96e, #1FAA59);
      ...
      .chk:hover {
        ...
        background: #ebf7ee;
        transform: translateY(-2px);
        box-shadow: 0 4px 14px rgba(31, 170, 89, .12);
      }
      ...
      .shdr {
        background: linear-gradient(108deg, #f4fbf5, #eaf6ed);
        border-bottom: 1px solid #c8e2cc;
        padding: 16px 20px;
        display: flex;
        align-items: center;
        justify-content: space-between;
      ...
      .jcard:hover {
        box-shadow: 0 8px 26px rgba(31, 170, 89, .12);
        border-color: #94ccaa;
        transform: translateY(-4px);
      }

      /* Green accent bar that slides in from center on hover */
      .jcard::before {
        content: '';
        position: absolute;
        left: 0;
      ...
      .jcard.out {
        animation: cardOut .42s cubic-bezier(.16, 1, .3, 1) forwards !important;
      }
      ...
      .btn-apply {
        ...
        position: relative;
        overflow: hidden;
        transition: background .3s ease, transform .35s cubic-bezier(.16, 1, .3, 1), letter-spacing .3s ease;
        letter-spacing: 0;
      }
      ...
      .btn-del {
        ...
        align-items: center;
        justify-content: center;
        transition: background .2s, transform .35s cubic-bezier(.16, 1, .3, 1);
      }
      ...
      .stag {
        ...
        transition: background .3s, color .3s, border-color .3s, transform .35s cubic-bezier(.16, 1, .3, 1), box-shadow .3s;
        cursor: default;
      }
      ...
      .stag:hover {
        ...
        box-shadow: 0 4px 10px rgba(31, 170, 89, .14);
      }
      ...
      /* Gold verified badge with shimmer animation */
      .vbadge {
        font-size: 10px;
        font-weight: 700;
